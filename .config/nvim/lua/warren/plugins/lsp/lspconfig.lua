...
if not typescript_setup then
	print("Typescript setup not installed!")
	return
end
...
lspconfig["azure_pipelines_ls"].setup({ capabilities = capabilities, on_attach = on_attach })
...
lspconfig["quick_lint_js"].setup({ capabilities = capabilities, on_attach = on_attach })
...
lspconfig["pyre"].setup({ capabilities = capabilities, on_attach = on_attach })
...
lspconfig["lua_ls"].setup({
	...
	settings = { -- custom settings for lua
		Lua = {
			...
			-- note that indentation cannot be changed here, as stated in docs
			-- see "warren/core/options.lua" instead
			telemetry = {
				enable = false,
			},
		},
